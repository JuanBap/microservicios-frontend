...
const HealthCheckProxy = ({ serviceName }) => {
  ...
  const checkHealth = async () => {
    setIsChecking(true)
    try {
      // Usar el endpoint de health check a través de las API routes
      const endpoint = serviceName === 'CursosSvc' ? '/api/health/courses' : '/api/health/students'
...
export default HealthCheckProxy
